	...
	if($count > 0){
		...
		echo '
				...
				<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
				  ...
				  <input type="hidden" name="business" value="merchant@canonstore.com">
				...
				echo   '
				<input type="hidden" name="return" value="https://wwwcanonpaymentcom.000webhostapp.com/payment_success.php"/>
